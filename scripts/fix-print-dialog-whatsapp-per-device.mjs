...
// 3) Format WhatsApp messages per device, with each device's own work items and cost.
{
...
console.log('✓ Auto print dialog and per-device WhatsApp formatting applied');
